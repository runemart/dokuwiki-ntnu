...
<div class="marginwrapper">
	<div id="ntnumenuwrap">
		...
		<ul id="ntnumenu" title="NTNU-navigasjon" class="selectedtab_<?php echo tpl_getConf('selectedtab'); ?>">
			...
			<li id="tab_student"><a href="http://ntnu.no/studitrh" title="Student i Trondheim">Student i Trondheim</a></li>
			...
			<li id="tab_om" class="selected"><a href="http://ntnu.no/omntnu" title="Om NTNU">Om NTNU</a></li>
